...
// automatically on unmount rather than leaking across route changes. The hero is
// a static intro video with no entrance animation.
    ...
    <div className="work-page" ref={rootRef}>
      <section className="mountain-section">
        <video className="hero-video" autoPlay loop muted playsInline>
          <source src="/Images/Intro video - work.mp4" type="video/mp4" />
        </video>
        <div className="mountain-container">
          <ParticleHeading text="The Work." variant="burst" />
